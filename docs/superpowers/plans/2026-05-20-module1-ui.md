...
**Status:** All 16 tasks complete (verified 2026-05-23)
...
- [x] Run: `npm install react-router-dom @tanstack/react-query react-hook-form zod xlsx`
...
- [x] Update `src/App.jsx` (route skeleton — full routes added in Task 7):
...
- [x] Ensure `src/index.css` starts with Tailwind directives:
...
- [x] Commit: `feat: install routing/query/form deps, wire providers`
...
- [x] Create `src/schemas/customer.js`:
...
- [x] Create `src/schemas/vehicle.js`:
...
- [x] Commit: `feat: add zod schemas for customer and vehicle forms`
...
- [x] Add to end of `src/lib/db/customers.js`:
...
- [x] Create `src/lib/db/dashboard.js`:
...
- [x] Commit: `feat: extend customers.js, add dashboard.js db helpers`
...
- [x] Add to end of `src/lib/db/vehicles.js`:
...
- [x] Replace `src/lib/db/documents.js` entirely (preserves existing + adds new):
...
- [x] Commit: `feat: extend vehicles.js and documents.js db helpers`
...
- [x] Commit: `feat: add storage.js helper for vehicle-documents bucket`
...
- [x] Create `src/components/ui/StatusBadge.jsx`:
...
- [x] Create `src/components/ui/PageHeader.jsx`:
...
- [x] Commit: `feat: add StatusBadge, EmptyState, PageHeader UI primitives`
...
- [x] Create `src/components/layout/GlobalSearch.jsx`:
...
- [x] Create `src/components/layout/AppShell.jsx`:
...
- [x] Commit: `feat: add AppShell, Sidebar, GlobalSearch layout components`
...
- [x] Commit: `feat: add Dashboard page with expiry alerts, stats strip, fleet age`
...
- [x] Create `src/pages/customers/CustomerList.jsx`:
...
- [x] Commit: `feat: add CustomerList page with search and filters`
...
- [x] Create `src/pages/customers/CustomerDetail.jsx`:
...
- [x] Commit: `feat: add CustomerDetail page with info cards and fleet table`
...
- [x] Create `src/pages/customers/CustomerForm.jsx`:
...
- [x] Run: `npm install @hookform/resolvers`
- [x] Commit: `feat: add CustomerForm with react-hook-form + zod validation`
...
- [x] Create `src/pages/vehicles/VehicleList.jsx`:
...
- [x] Commit: `feat: add VehicleList page with search, filters, next expiry`
...
- [x] Create `src/pages/vehicles/VehicleDetail.jsx`:
...
- [x] Commit: `feat: add VehicleDetail page with specs and document cabinet mount`
...
- [x] Create `src/pages/vehicles/DocumentCabinet.jsx`:
...
- [x] Commit: `feat: add DocumentCabinet with 12 doc type cards, upload, signed URL view`
...
- [x] Create `src/pages/vehicles/VehicleForm.jsx`:
...
- [x] Commit: `feat: add VehicleForm with all JPJ fields, 5 sections, zod validation`
...
- [x] Create `src/pages/import/ImportPage.jsx`:
...
- [x] Run: `npm install uuid`
- [x] Commit: `feat: add ImportPage with SheetJS parsing, 3-tab review, batch promote`
